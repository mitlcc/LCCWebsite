...
class History extends Component {
  ...
  getFlagIcon(countryCode) {
    ...
    return (
      <img alt={countryCode} style={{ "margin-top": "1rem" }} src={link} />
    );
  }
        ...
        <VerticalTimeline>
          ...
          >
            ...
            <h6>
              ...
              <ol>
                <li>
                  Working with the Office of Admissions to recruit more Hispanic
                  Americans to MIT
                </li>
                <li>
                  Monitoring MIT's commitment to having a truly diverse
                  educational community
                </li>
                <li>
                  Discussing politcal affairs related to Chicanos and other
                  human beings
                </li>
                <li>
                  Sponsoring social events, such as picnics, dinners, parties,
                  etc., accented with Mexican festivity
                </li>
              </ol>
            </h6>
          ...
          >
            <h3>
              ...
              Raymond Morales, Desiree Ramierz, and Terrence Strader
            </h3>
            ...
            <h6>
              ...
              <ol>
                <li>
                  Latino population was “largest underrepresented minority group
                  at MIT”, but consistently had a 90% retention rate at a time
                  when MIT's overall retention rate was 98%.
                </li>
                <li>
                  Many students reporting culture shock and cultural isolation,
                  affecting their time at MIT{" "}
                </li>
              </ol>
              Their own experiences:
              <ol>
                <li>
                  “Walking through the halls of MIT, one does not hear Spanish
                  on a regular basis”
                </li>
                <li>Very few people knew who Ceasar Chavez was</li>
                <li>
                  There was not a single portrait hanging on MITs walls of a
                  Latino
                </li>
              </ol>
              Proposal included:
              <ol>
                <li>
                  A list of possible locations for the new center - Student
                  Center, past OME office, Stata, Walker
                </li>
                <li>Full working kitchen for food events</li>
                <li>Space with minimum capacity of 60 students</li>
                <li>
                  Office space big enough to sufficiently accommodate the 6
                  Latino organizations at MIT at the time: LuCha, SHPE, MAES,
                  APR, Mujeres Latinas, Phi Delta Upsilon
                </li>
                <li>
                  Shelves to store and maintain a Latino Literature Library
                </li>
                <li>Reading room, Storage Space</li>
              </ol>
            </h6>
          ...
          >
            ...
            <h6>
              ...
              outside of campus and celebrate Peruvian culture. Club Peru officially joined the LCC in 2019 as well.
            </h6>
          ...
          >
            ...
            <section className="history-img">
              <img alt="LDC" src="images/loader.gif" />
            </section>

            <h6>
              The LDC was created to celebrate different Latin dances and hosts
              several events during the semester. The LDC officially joined the LCC in 2023.
            </h6>
